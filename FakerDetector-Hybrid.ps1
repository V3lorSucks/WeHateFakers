...
<body>
    <div class="container">
        <header class="header">
            ...
            <div class="credits">
                VMAware by kernelwernel | FakerDetector by @praiselily [Lily] and @valor4.0 [DrValor]<br>
                Hybrid Integration by AI Assistant
            </div>
        </header>
"@
...
<div class='footer'>
    <p>Hybrid Detection Report generated by FakerDetector + VMAware</p>
    <p>VMAware: https://github.com/kernelwernel/VMAware (MIT License)</p>
    <p>FakerDetector: Designed by @praiselily [Lily] and @valor4.0 [DrValor]</p>
